...
export const cabins = [
  {
    ...
    description:
      "Discover the ultimate luxury getaway for couples in the cozy Taj Retreat. Nestled in a serene forest, this stunning cabin offers a secluded and intimate retreat. Inside, enjoy modern high-quality wood interiors, a comfortable seating area, a fireplace, and a fully-equipped kitchen. The plush king-size bed guarantees a peaceful night's sleep. Relax in the spa-like shower and unwind on the private deck with a hot tub.",
  },
  {
    name: "Oberoi Oasis",
    maxCapacity: 2,
  ...
  },
  {
    ...
    description:
      "Accommodate your large group or multiple families in the spacious and grand wooden Vivanta Vista. Designed to comfortably fit up to 8 people, this cabin offers a secluded retreat in the heart of beautiful forests and mountains. Inside, the cabin features warm and inviting interiors crafted from quality wood, multiple living areas with a fireplace, and a fully-equipped kitchen. The bedrooms are comfortable and equipped with en-suite bathrooms. The cabin has a private deck with a hot tub and outdoor seating area, perfect for taking in the natural surroundings.",
  },
  {
